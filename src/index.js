...
const InputSchema = z.object({
  ...
  shape: z.array(CoordinatePair).min(3, "shape must have at least 3 vertices").optional().describe("Vertices of a convex, hole-free polygon as [[x,y], [x,y], ...]. Automatically normalized to counterclockwise orientation. Defaults to unit square [[0,0], [1,0], [1,1], [0,1]] if omitted. Coordinates can be in any coordinate system (pixels, normalized 0-1, abstract units, etc.). Output polygon coordinates are returned in the same coordinate system as this input shape. Minimum 3 vertices required for custom shapes. Examples:\n- Square: [[0,0], [100,0], [100,100], [0,100]]\n- Triangle: [[0,0], [10,5], [5,10]]\n- Pentagon: [[0,0], [2,0], [3,1.5], [1,3], [-1,1.5]]"),
