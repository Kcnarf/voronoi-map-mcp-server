...
export const CellSchema = z.object({
  ...
  site: CoordinatePair.describe("The [x,y] coordinate of the cell's site (Voronoi seed point). This is the point around which the cell is centered, ideal for label placement. Computed via Lloyd relaxation, so at convergence it equals the geometric centroid of the polygon"),
...
}).describe("Voronoi cell with polygon coordinates, site location, and original datum. Output coordinates are in the same system as the input shape");
